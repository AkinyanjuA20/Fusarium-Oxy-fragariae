...
/home/gomeza/miniconda3/envs/general_tools/bin/BuildDatabase -name "$Strain"_RepMod "$Strain"_contigs_unmasked.fa
/home/gomeza/miniconda3/envs/general_tools/bin/RepeatModeler -pa 16 -database "$Strain"_RepMod

/home/gomeza/miniconda3/envs/general_tools/bin/RepeatClassifier -consensi RM_*.*/consensi.fa -stockholm RM_*.*/families.stk

# hardmask
/home/gomeza/miniconda3/envs/general_tools/bin/RepeatMasker -gff -pa 16 -lib RM_*.*/consensi.fa.classified "$Strain"_contigs_unmasked.fa
...
# softmask
/home/gomeza/miniconda3/envs/general_tools/bin/RepeatMasker -xsmall -gff -pa 16 -lib RM_*.*/consensi.fa.classified "$Strain"_contigs_unmasked.fa
...
/home/gomeza/miniconda3/envs/general_tools/bin/RepeatMasker -nolow -gff -pa 16 -lib RM_*.*/consensi.fa.classified "$Strain"_contigs_unmasked.fa
