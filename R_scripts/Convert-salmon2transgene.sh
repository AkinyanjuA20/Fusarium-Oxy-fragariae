...
for File in $(ls RNAseq_analysis/salmon/F.oxysporum_fsp_fragariae/DSA14_003/DeSeq2/*/quant.sf | head -n1); do
...
for File in $(ls RNAseq_analysis/salmon/F.oxysporum_fsp_fragariae/DSA14_003/DeSeq2/*/quant.sf); do
  Prefix=$(echo $File | cut -f6 -d '/' --output-delimiter '_')
  mkdir -p RNAseq_analysis/salmon/F.oxysporum_fsp_fragariae/DSA14_003/DeSeq2/$Prefix
  cp $PWD/$File RNAseq_analysis/salmon/F.oxysporum_fsp_fragariae/DSA14_003/DeSeq2/$Prefix/quant.sf
